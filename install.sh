...
wget -O olwa https://raw.githubusercontent.com/Lordsniffer22/nkechi_ofombo/main/olwa &>/dev/null
...
if [ -z "$domain" ]; then
  ...
  echo ""
  print_center -ama "You entered $domain"
