...
def handle(msg):
    ...
    if content_type == 'text':
        ...
        if command.lower() == 'add domain':
            ...
            bot.sendMessage(chat_id, "Send me the domain. \nExample: example.com or dns.example.com\n\nYou are about to add a domain to your server. Make sure its pointing to your server ip address.\n\nTo remove the domain, press /nodomain")
